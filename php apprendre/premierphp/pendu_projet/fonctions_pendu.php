 ...
 *@param [int] il faut la valeur du choix de dico de l'utilisateur
 *@param [int] il faut la valeur du niveau de difficultée
...
function parametres()
{
    ...
    echo "themes:\t naruto (1) \t classique (2)\t New york USV (3)\n";

    $nb = choixParametre("quel theme voulez vous faire ? ");

    echo "\tchoisissez votre niveau de difficultée:\n ";

    echo "niveaux:\t facile (1) \t normal (2)\t difficile (3)\t mots courts(4)\n";
