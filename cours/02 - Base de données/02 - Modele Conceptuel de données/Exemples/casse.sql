...
#        Script MySQL.
#------------------------------------------------------------
DROP DATABASE IF EXISTS casse;

CREATE DATABASE casse;
...
# Table: convient
#------------------------------------------------------------
CREATE TABLE casse.convient(
    idTypePiece Int NOT NULL PRIMARY KEY,
...
ALTER TABLE
    casse.convient
ADD
    CONSTRAINT convient_TypePieces_FK FOREIGN KEY (idTypePiece) REFERENCES TypePieces(idTypePiece);

ALTER TABLE
    casse.convient
ADD
    CONSTRAINT convient_Modele0_FK FOREIGN KEY (idModele) REFERENCES Modele(idModele);