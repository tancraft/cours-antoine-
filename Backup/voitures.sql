...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mar. 20 oct. 2020 à 07:58
...
(56, 'M5', 32),
(57, 'Grand Prix', 10),
(58, 'Discovery Series II', 1),
(59, 'Grand Cherokee', 33),
(60, 'Mustang', 14),
(61, 'Intrigue', 29),
(62, 'Tacoma Xtra', 21),
(63, 'CLS-Class', 34),
...
--
ALTER TABLE `modeles`
  ADD CONSTRAINT `modeles_marques_FK` FOREIGN KEY (`idMarque`) REFERENCES `marques` (`idMarque`);
COMMIT;
