...
INSERT INTO `reservations` VALUES (3,'2019-04-20','2019-05-07','2019-05-09',2400,800,1,1,'','2020-10-28 13:55:09','2020-10-28 13:56:07'),(4,'2019-11-04','2019-11-13','2019-11-17',400,50,3,1,'','2020-10-28 13:55:09',NULL),(5,'2020-01-11','2020-02-12','2020-02-18',3400,100,2,2,'','2020-10-28 13:55:09',NULL),(6,'2019-06-19','2019-08-05','2019-08-18',7200,180,4,2,'','2020-10-28 13:55:09',NULL),(7,'2019-04-02','2019-04-29','2019-05-03',1400,450,5,3,'','2020-10-28 13:55:09',NULL),(8,'2019-10-20','2019-12-01','2019-12-15',2400,780,6,4,'','2020-10-28 13:55:09',NULL),(9,'2019-02-27','2019-03-31','2019-04-04',500,80,6,4,'','2020-10-28 13:55:09',NULL),(10,'2019-07-21','2019-08-16','2019-08-16',40,0,8,4,'','2020-10-28 13:55:09',NULL),(11,'2019-10-12','2019-11-23','2019-11-29',580,58,15,8,'','2020-10-28 13:55:09',NULL),(12,'2019-12-22','2020-01-27','2020-01-30',140,14,17,9,'','2020-10-28 13:55:09',NULL),(13,'2019-07-21','2019-08-18','2019-08-21',360,36,15,8,'','2020-10-28 13:55:09',NULL),(14,'2019-01-10','2019-02-20','2019-03-01',1380,138,20,4,'','2020-10-28 13:55:09',NULL),(15,'2019-04-09','2019-04-17','2019-05-02',420,42,16,13,'','2020-10-28 13:55:09',NULL),(16,'2019-05-21','2019-06-13','2019-06-26',360,36,16,13,'','2020-10-28 13:55:09',NULL),(17,'2019-07-26','2019-08-09','2019-08-20',680,68,1,12,'','2020-10-28 13:55:09',NULL),(18,'2019-11-29','2019-11-30','2019-12-14',1280,128,15,21,'','2020-10-28 13:55:09',NULL),(19,'2019-03-12','2019-04-06','2019-04-09',420,42,19,14,'','2020-10-28 13:55:09',NULL),(20,'2019-01-17','2019-01-24','2019-01-28',260,26,12,24,'','2020-10-28 13:55:09',NULL),(21,'2020-01-02','2020-02-15','2020-02-24',1380,138,9,12,'','2020-10-28 13:55:09',NULL),(22,'2019-09-10','2019-09-24','2019-10-01',1430,143,12,4,'','2020-10-28 13:55:09',NULL),(23,'2019-05-11','2019-06-10','2019-06-14',820,82,1,23,'','2020-10-28 13:55:09',NULL),(24,'2019-10-21','2019-10-24','2019-10-31',650,65,11,10,'','2020-10-28 13:55:09',NULL),(25,'2020-01-12','2020-03-04','2020-03-09',1290,129,14,20,'','2020-10-28 13:55:09',NULL),(26,'2019-04-02','2019-05-02','2019-05-09',1030,103,19,15,'','2020-10-28 13:55:09',NULL),(27,'2019-01-04','2019-02-15','2019-02-25',470,47,17,17,'','2020-10-28 13:55:09',NULL),(28,'2019-05-17','2019-05-31','2019-06-03',1460,146,16,14,'','2020-10-28 13:55:09',NULL),(29,'2019-04-12','2019-05-23','2019-05-28',1310,131,6,21,'','2020-10-28 13:55:09',NULL),(30,'2019-06-26','2019-07-15','2019-07-21',460,46,9,20,'','2020-10-28 13:55:09',NULL),(31,'2019-04-09','2019-05-23','2019-05-27',350,35,17,18,'','2020-10-28 13:55:09',NULL),(32,'2019-06-14','2019-08-02','2019-08-04',890,89,14,23,'','2020-10-28 13:55:09',NULL),(33,'2019-03-06','2019-03-23','2019-03-31',1440,144,14,12,'','2020-10-28 13:55:09',NULL),(34,'2019-03-27','2019-04-29','2019-05-07',1010,101,17,19,'','2020-10-28 13:55:09',NULL),(35,'2019-02-11','2019-03-08','2019-03-22',790,79,13,16,'','2020-10-28 13:55:09',NULL),(36,'2019-04-15','2019-04-23','2019-05-04',270,27,5,2,'','2020-10-28 13:55:09',NULL),(37,'2019-03-25','2019-05-02','2019-05-16',660,66,19,19,'','2020-10-28 13:55:09',NULL),(38,'2019-05-01','2019-06-14','2019-06-18',140,14,13,4,'','2020-10-28 13:55:09',NULL),(39,'2020-01-10','2020-02-24','2020-02-29',1460,146,14,19,'','2020-10-28 13:55:09',NULL),(40,'2019-11-24','2019-11-30','2019-12-01',790,79,6,4,'','2020-10-28 13:55:09',NULL),(41,'2020-01-13','2020-01-30','2020-02-14',390,39,15,20,'','2020-10-28 13:55:09',NULL);
...
/*!50001 VIEW `stationchambre` AS select `stations`.`nomStation` AS `nomStation`,`hotels`.`nomHotel` AS `nomHotel`,`chambres`.`numChambre` AS `numChambre` from ((`hotels` join `chambres` on((`chambres`.`idHotel` = `hotels`.`idHotel`))) join `stations` on((`hotels`.`idStation` = `stations`.`idStation`))) */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `stationchambreleft` AS select `stations`.`nomStation` AS `nomStation`,`hotels`.`nomHotel` AS `nomHotel`,`chambres`.`numChambre` AS `numChambre` from ((`hotels` left join `chambres` on((`chambres`.`idHotel` = `hotels`.`idHotel`))) left join `stations` on((`hotels`.`idStation` = `stations`.`idStation`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
